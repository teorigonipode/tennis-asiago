      ...
      <div className="mx-auto max-w-md">
        <div className="card p-8">
          <div className="mb-6 text-center">
            ...
            <h1 className="font-display text-2xl font-bold text-forest-900">Recupero password</h1>
            <p className="mt-1 text-sm text-cream-500">Riceverai un link per reimpostare la password.</p>
          </div>
