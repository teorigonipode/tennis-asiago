...
import { addDays, isSameDay, toISODate, WEEKDAYS_SHORT, cn } from '@/lib/utils';
...
export function Calendar({
  ...
  return (
    <div className="card p-4">
      ...
      <div className="mb-2 grid grid-cols-7 gap-1 text-center text-xs font-semibold text-ink-400">
          ...
          return (
            <button
              ...
              className={cn(
                ...
                isSelected && 'bg-court-600 text-white font-bold shadow-soft',
                !isSelected && !disabled && 'text-ink-700 hover:bg-court-50 hover:text-court-700',
